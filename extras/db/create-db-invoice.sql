...
--        chown postgres:postgres /var/lib/postgresql/tablespace/invoice
...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-invoice.sql
--        psql --dbname=invoice --username=invoice --file=/sql/create-schema-invoice.sql
...
CREATE ROLE invoice LOGIN PASSWORD 'p';

-- https://www.postgresql.org/docs/current/sql-createdatabase.html
CREATE DATABASE invoice;

-- https://www.postgresql.org/docs/current/sql-grant.html
GRANT ALL ON DATABASE invoice TO invoice;

-- https://www.postgresql.org/docs/10/sql-createtablespace.html
CREATE TABLESPACE invoicespace OWNER invoice LOCATION '/var/lib/postgresql/tablespace/invoice';
