...
public final class Banner {
  ...
  private static final String SERVICE_HOST = System.getenv("INVOICE_SERVICE_HOST");
  private static final String KUBERNETES = SERVICE_HOST == null
    ? "N/A"
    : String.format("INVOICE_SERVICE_HOST=%s, INVOICE_SERVICE_PORT=%s", SERVICE_HOST, System.getenv("INVOICE_SERVICE_PORT"));
